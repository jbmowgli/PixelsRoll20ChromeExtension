...
describe('ModifierBox Drag Handler', () => {
  ...
  describe('Module Initialization', () => {
    ...
    test('should expose setupDragFunctionality method', () => {
      expect(window.ModifierBoxDragHandler.setupDragFunctionality).toBeInstanceOf(Function);
    });
  });
  ...
  describe('setupDragFunctionality', () => {
    ...
    test('should handle null modifierBox parameter', () => {
      ...
      expect(console.error).toHaveBeenCalledWith("setupDragFunctionality: modifierBox is required");
    });
    ...
    test('should handle missing header element', () => {
      ...
      expect(console.error).toHaveBeenCalledWith("setupDragFunctionality: header not found");
    });
